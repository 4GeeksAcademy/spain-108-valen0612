...
from .models import db, Users,Posts,Media,Coments,Followers,CaractersFavorites,PlanetsFavorites,Characters,Planets
...
def setup_admin(app):
    ...
    admin.add_view(ModelView(CaractersFavorites, db.session))
